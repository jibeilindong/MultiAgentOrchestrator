...
enum WorkbenchActiveRunStatus: String, Codable, CaseIterable, Hashable {
    case running
    case stopping
}

struct WorkbenchActiveRunRecord: Codable, Identifiable, Hashable {
    let id: String
    var threadID: String
    var workflowID: String
    var runID: String
    ...
    var startedAt: Date
    var updatedAt: Date
    var status: WorkbenchActiveRunStatus
