...
- 记录这个 agent 正在帮助的“人”的上下文信息
- 作为持续了解用户的标准入口文件

预期内容：

- 以 `# USER.md - About Your Human` 为标题的标准脚手架
- 用户姓名、称呼、代词、时区、备注等基础信息
- 一个明确的 `## Context` 区块，用于持续补充用户关心什么、在做什么、讨厌什么、觉得什么有趣

规则：

- 这个文件描述的是“用户本人”，而不是模板介绍
- 需要保持尊重、克制，帮助 agent 更好地协作，而不是把用户做成档案
- 对标准模板来说，即使还没有真实用户资料，这个文件也必须先具备完整、可直接填写的标准内容
